...
# Définir explicitement le chemin de mycroft-core comme le répertoire courant
mycroft_core_dir = os.path.abspath(os.path.dirname(__file__))

# Définir les chemins relatifs basés sur le répertoire mycroft-core
    ...
    if os.path.isfile(mycroft_conf_path):
        with open(mycroft_conf_path, 'r') as conf_file:
            try:
                ...
                print(f"Error reading {mycroft_conf_path}: {e}")
                return
